...
interface CommonPartiallyOwnedInterface extends ethers.utils.Interface {
  functions: {
...
export class CommonPartiallyOwned extends BaseContract {
  ...
  interface: CommonPartiallyOwnedInterface;
